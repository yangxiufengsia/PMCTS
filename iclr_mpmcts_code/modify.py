        ...
        if ret==True:
            ...
            if cur_status.Get_tag()==0:
                ...
                if hs.get(make_string(message[0]))==None:
                    ...
                    #comm.send(childnode.state,dest=hs.hashing(make_string(childnode.state)),tag=0)
                    ...
                    if checks==0:
                        ...
                        print ("state_in_queue1:",state_in_queue1)
                        #print ("check q for sim:",q.get())
