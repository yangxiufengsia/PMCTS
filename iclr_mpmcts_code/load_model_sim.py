...
def loaded_model_sim():
    json_file = open('/home/yang/riken-projects/sc_chem/RNN-model-sim/model.json', 'r')
    ...
    loaded_model.load_weights('/home/yang/riken-projects/sc_chem/RNN-model-sim/model.h5')
